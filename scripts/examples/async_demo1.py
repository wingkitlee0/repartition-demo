...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-files", "-nf", type=int, default=3, help="number of files")
    parser.add_argument("--batch-size", "-b", type=int, default=100_000, help="batch size per block")
